# Welcome to the Caption Studio by Lyzr!

![Lyzr Logo](./logo/lyzr-logo.png)

This Caption Studio, an application utilizing Lyzr Automata. Users provide a brief Instagram caption topic, and the Lyzr Automata generates creative captions and generates a corresponding unique image.
